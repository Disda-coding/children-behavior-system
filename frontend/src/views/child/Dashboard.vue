  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <!-- 总积分 -->
        <div class="bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl p-6 text-white card-hover">
        ...
        <div v-else class="space-y-4">
          ...
          >
            <div class="flex items-center space-x-3">
              <div
                :class="[
                  ...
                  record.type === 'earn' ? 'bg-success-100 text-success-600' :
                  record.type === 'deduct' ? 'bg-danger-100 text-danger-600' :
            ...
            <span
              :class="[
                'font-bold',
                record.type === 'earn' ? 'text-success-600' :
                record.type === 'deduct' ? 'text-danger-600' :
                'text-gray-600'
              ]"
            >
